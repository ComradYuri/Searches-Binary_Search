...
result = binary_search_recursive(values, start_of_values, end_of_values, 288)
result2 = binary_search_recursive(values, start_of_values, end_of_values, 600)

print("element {0} is located at index {1}".format(288, result))
print("element {0} is located at index {1}".format(600, result2))
